...
void MainWindow::about()
{
    QMessageBox::about(this, tr("About Hardwaretest_master"),
                       tr("<b>Hardwaretest_master v4.3 </b><br><br> The <b>Hardwaretest_master</b> used as chipsee hardwaretest master, "
